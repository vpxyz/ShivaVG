...
createPaths(void)
{
   ...
   if (!backdrop) {
      ...
      vgClearPath(backdrop, VG_PATH_CAPABILITY_ALL);
...
VGPath
getRectangle(float x, float y, float w, float h)
{
...
drawWall(void)
{
   ...
   path = testCreatePath();
   {
      ...
      VG_CUBIC_TO_REL, VG_CUBIC_TO_REL, VG_CUBIC_TO_REL, VG_CUBIC_TO_REL,
      VG_LINE_TO_REL };
   ...
   path = testCreatePath();
   {
      VGubyte segs[] =
         { VG_MOVE_TO_ABS, VG_CUBIC_TO_REL, VG_CUBIC_TO_REL, VG_CUBIC_TO_REL,
      VG_CUBIC_TO_REL, VG_CUBIC_TO_REL, VG_CUBIC_TO_REL, VG_CUBIC_TO_REL,
      VG_CUBIC_TO_REL, VG_CUBIC_TO_REL, VG_CUBIC_TO_REL };
   ...
   path = testCreatePath();
   {
      VGubyte segs[] =
         { VG_MOVE_TO_ABS, VG_CUBIC_TO_REL, VG_CUBIC_TO_REL, VG_CUBIC_TO_REL,
      VG_CUBIC_TO_REL, VG_CUBIC_TO_REL, VG_CUBIC_TO_REL, VG_CUBIC_TO_REL,
      VG_CUBIC_TO_REL, VG_CUBIC_TO_REL, VG_CUBIC_TO_REL, VG_CUBIC_TO_REL, VG_CUBIC_TO_REL,
      VG_LINE_TO_ABS };
   ...
   path = testCreatePath();
   {
      ...
      VG_CUBIC_TO_ABS, VG_CUBIC_TO_ABS, VG_LINE_TO_ABS };
   ...
   {
      VGubyte segs[] =
         { VG_MOVE_TO_ABS, VG_CUBIC_TO_ABS, VG_CUBIC_TO_REL, VG_CUBIC_TO_REL,
      VG_CUBIC_TO_REL, VG_CUBIC_TO_REL, VG_CUBIC_TO_REL, VG_CUBIC_TO_ABS,
      VG_CUBIC_TO_ABS };
   ...
   path = testCreatePath();
   {
      VGubyte segs[] =
         { VG_MOVE_TO_ABS, VG_CUBIC_TO_REL, VG_CUBIC_TO_REL, VG_CUBIC_TO_REL,
      VG_CUBIC_TO_REL, VG_CUBIC_TO_REL, VG_CUBIC_TO_REL, VG_CUBIC_TO_REL,
      VG_CUBIC_TO_REL, VG_LINE_TO_REL, VG_LINE_TO_REL };
