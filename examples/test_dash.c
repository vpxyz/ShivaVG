...
updateOverlayString(void)
{
   switch (mode) {
   case 'd':
      testOverlayString("Dash Phase mode");
      break;
   case 'x':
...
key(unsigned char code, int x, int y)
{
   ...
   case 'c':
      ...
      switch (caps[cindex]) {
      case VG_CAP_BUTT:
         testOverlayString("Dash caps: BUTT\n");
         break;
      case VG_CAP_SQUARE:
         testOverlayString("Dash caps: SQUARE\n");
         break;
      case VG_CAP_ROUND:
         testOverlayString("Dash caps: ROUND\n");
         break;
      }
      return;
   ...
   case 'j':
      ...
      switch (joins[jindex]) {
      case VG_JOIN_MITER:
         testOverlayString("Dash joins: MITER\n");
         break;
      case VG_JOIN_BEVEL:
         testOverlayString("Dash joins: BEVEL\n");
         break;
      case VG_JOIN_ROUND:
         testOverlayString("Dash joins: ROUND\n");
         break;
      }
      return;
