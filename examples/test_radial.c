...
void
createCross(VGPath p, VGfloat x, VGfloat y)
{
   VGfloat D = 20;
...
void
createArrow(VGPath p, VGfloat cx, VGfloat cy, VGfloat dx, VGfloat dy)
{
   VGfloat px = -dy, py = dx;
...
updateOverlayString(void)
{
   switch (mode) {
   case 'c':
      testOverlayString("Gradient Center mode");
      break;
   case 'f':
      testOverlayString("Gradient Focus mode");
      break;
   case 'r':
      testOverlayString("Gradient Radius mode");
      break;
   case 'x':
...
key(unsigned char key, int x, int y)
{
   ...
   case TAB:
      ...
      switch (sindex) {
      case 0:
         testOverlayString("Gradient Spread mode: PAD");
         break;
      case 1:
         testOverlayString("Gradient Spread mode: REPEAT");
         break;
      case 2:
         testOverlayString("Gradient Spread mode: REFLECT");
         break;
      }
      return;
